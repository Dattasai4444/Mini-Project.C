...
/*group members - VALAVALA KESAVA SWAMY MOHANA SANJEEVI, RA2111003011652
LAGHUSANI DATTA SAI, RA2111003011661 - X1 section CSE CORE*/
#include<stdio.h>
    #include<math.h>
    int main()
    {
